...
#: Минут в часе. Константы вольта заданы в часах (`mining.iron_per_hour`,
#: `wound.recovery_hours`), а сессии живут в минутах.
MINUTES_PER_HOUR = 60.0

#: Argon2id принимает память в КиБ, а `pow.memory_per_session` задан в МБ.
KIB_PER_MIB = 1024
