...
Запуск: `python -m octoverse.worker`.
...
from octoverse.constants import bootstrap
from octoverse.db.base import dispose, session_factory
from octoverse.engine import tick
from octoverse.engine.jobs import require_handlers, run_due
from octoverse.runtime import WORKER_IDLE_SLEEP
