...
class Formula:
    ...
    Значение — **документация**, а не исполняемое выражение: формулу движок
    реализует кодом, а строка отсюда фиксирует, какую именно. Расхождение —
    вопрос к человеку, а не повод молча посчитать иначе (07-implementation-map).
    """
