...
battery-not-here = that battery is not here
battery-charge-in-hands = “{ NAME($goods) }” is not charged in hand: put it up first
battery-charge-lying = “{ NAME($goods) }” is lying, and only a battery that stands is charged: put it up
