...
thing-gone = “{ NAME($goods) }” is no longer here: it went while you were reaching
thing-taken-apart = this is being taken apart and does not leave your hands while the work goes on: “{ NAME($goods) }”
...
battery-not-here = that battery does not stand here
battery-charge-in-hands = “{ NAME($goods) }” is not charged in hand: put it up in the building first
battery-charge-lying = “{ NAME($goods) }” is lying loose, and only a battery that stands is charged: put it up in the building
