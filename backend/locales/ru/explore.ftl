...
explore-not-land = там вода или край света: узлу не на чём стоять
...
explore-crosses-way = путь туда пересёк бы уже проложенный: разведывают между дорог, а не поперёк
