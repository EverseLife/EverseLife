...
battery-not-here = этого аккумулятора здесь нет
battery-charge-in-hands = «{ NAME($goods) }» в руках не заряжают: сначала поставьте его
battery-charge-lying = «{ NAME($goods) }» лежит, а заряжают поставленный: поставьте его
