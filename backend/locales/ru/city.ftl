...
city-found-name-taken = город с именем «{ $name }» уже есть: имя города становится именем его канала в Сети, а двух одинаковых там не бывает
...
access-barred = «{ $node }» — чужая локация, и хозяин вас туда не пускает. Пройти через неё можно, остановиться — нет; спор о входе решается иском
