...
# города отошёл городу. Деталь за разделителем — имя узла, а у находки —
# слово её фацета или биома на языке читателя.
event-land-annexed = земля на конце тракта отошла городу
# Земля города — всё внутри его границы (D-356): ничей узел, который граница
# накрыла, отошёл городу; узел, от которого она отступила, снова ничей.
# Деталь за разделителем — имя узла, а у находки — слово её фацета или
# биома на языке читателя.
event-land-covered = земля в границах города стала городской
event-land-uncovered = граница города отступила: земля снова ничья
