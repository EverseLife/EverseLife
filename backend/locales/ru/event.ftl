...
# Полевой автомат (D-339): у него новая причина стоять; деталь — узел, сама причина — в окне машины.
event-agro-stalled = полевой автомат просит внимания
event-body-died = тело погибло
event-body-printed = напечатано тело
# Снаружи нечем дышать (D-343): начался отсчёт до удушья — баллоны пусты или
# их не с чем соединить.
event-body-airless = тело начало задыхаться
# Надетое не переживёт следующего суточного износа (D-343). Деталь за
# разделителем — сама вещь.
event-gear-wearing_out = снаряжение не переживёт следующих суток
...
# Воздух на борту (D-233, D-340): предупреждения экипажу. Деталь за
# разделителем — что кончилось или переполнилось, либо сама машина.
event-ship-airless = на борту кончается воздух
