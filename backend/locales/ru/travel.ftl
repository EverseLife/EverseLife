...
travel-scouting = тело в разведке: { $left } — второе дело подождёт
travel-no-route = { $how ->
...
ship-in-flight = корабль «{ $ship }» уже в пути: до конца перехода он приказов не берёт
...
ship-no-fuel = { $why ->
        ...
        [cross] на уход в рейс топлива не хватает
...
ship-cross-from-orbit = «{ $ship }» стоит на космодроме: переходы между планетами начинаются с орбиты. Сначала поднимитесь на орбиту
ship-cross-to-orbit = «{ $node }» — не планета: переход идёт к планете, а космодром выбирают уже на её орбите
ship-already-over-planet = «{ $ship }» уже на орбите этой планеты: отсюда садятся, а не идут переходом
ship-nowhere-to-land = на планете { PLANET($planet) } садиться некуда: не светит ни один маяк. Корабль ушёл бы туда и остался на орбите
...
ship-target-unseen = цели не видно: чужой корпус виден ближе { NUMBER($radius) } ед. карты или когда оба на орбите одной планеты
ship-target-not-adrift = целью бывает только корпус в небе без приказа: погибший, под приказом, у причала, на подъёме или спуске и на удержании не встретить
...
ship-meet-from-orbit = к кораблю на орбите подходят с орбиты: сначала курс к планете { PLANET($planet) }, потом встреча
...
ship-orbit-only-in-space = на орбиту звезды выходят из космоса, а корабль стоит у причала · { $ship }
...
ship-not-in-orbit = «{ $ship }» не на орбите планеты: садятся только с орбиты — сначала курс к планете
ship-orbit-too-high = «{ $ship }» на слишком высокой орбите, чтобы садиться: сначала проложите курс к этой же планете — автопилот опустит корабль на стоянку
ship-land-other-planet = «{ $node }» на другой планете: с орбиты садятся на ту, вокруг которой летят, а до чужой идут переходом
...
ship-no-home-to-turn-to = неизвестно, откуда ушёл корабль «{ $ship }»: развернуться не к чему, и рейс придётся довести до конца
...
ship-hours-out-of-range = на { NUMBER($hours) } ч ползунок этому кораблю ничего не предлагает. Выберите точку на ползунке заново
ship-hours-are-a-flyby = на { NUMBER($hours) } ч ползунок предлагает не прямую дугу, а пролёт: { PLANET($planet) }. Выберите на ползунке этот пролёт или другую точку
ship-no-arc = на { NUMBER($hours) } ч небо дуги не даёт: всякая срезает корону звезды. Выберите другую точку на ползунке
ship-no-arc-fits = ни одну дугу двигатели не вытянут: самой дешёвой, на { NUMBER($hours) } ч, нужно { NUMBER($need) } ед. скорости, а они выдают { NUMBER($have) }. Снимите массу или ставьте двигатели
ship-no-flyby = пролёт: { PLANET($planet) } — на { NUMBER($hours) } ч ползунок этому кораблю его не предлагает. Выберите точку на ползунке заново
