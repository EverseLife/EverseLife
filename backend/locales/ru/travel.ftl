...
ship-planet-has-no-orbit = у планеты { PLANET($planet) } нет орбиты: подниматься некуда
ship-cross-from-orbit = «{ $ship }» стоит в космодроме: между планетами ходят с орбиты. Сначала поднимитесь на орбиту
...
ship-not-in-orbit = «{ $ship }» не на орбите планеты: садятся с орбиты, а корабль летит мимо
ship-orbit-too-high = «{ $ship }» на орбите слишком высоко, чтобы садиться: сначала курс к планете — автопилот опустит корабль на круг стоянки
