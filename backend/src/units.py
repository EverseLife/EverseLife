...
#: Часов в сутках Терры движок берёт из вольта (`time.day_terra`), а вот
#: единица тарифа задана самим вольтом как «ТК за 100 энергии»: это запись
#: цены, а не её величина.
ENERGY_PER_TARIFF_UNIT = 100.0

#: Промилле: проба монеты задана в тысячных долях (`coin.default_fineness`
#: = 900). Это определение единицы, а не баланс — балансное значение самой
#: пробы лежит в `coin.*`.
PERMILLE = 1000.0
...
#: Секунд в часе: рёбра карты и сон живут в секундах, ставки вольта — в часах.
