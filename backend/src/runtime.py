...
#: The processes the sliders with their flyby refinements run in (D-341): one
#: per hull's slider asked about at once, and no more -- each is a whole core
#: while it works, and a third reader waits for one of them.
SKY_WORKERS = 2
