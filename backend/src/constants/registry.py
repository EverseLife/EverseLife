...
from src.constants.registry_farm import *  # noqa: F403 -- the farm's keys are declared beside
...
#: The direct arc's horizon (D-317): no direct arc longer than this, however
#: cheap. A flyby is searched on past it (D-341).
