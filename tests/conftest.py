...
from octoverse.constants import Catalog, Constants, bootstrap
from octoverse.models import Base

REPO = Path(__file__).resolve().parents[1]
VAULT_BUILD = Path(
    os.environ.get("OCTOVERSE_VAULT_BUILD", REPO / ".." / "octoverse-game-design" / "build")
)
