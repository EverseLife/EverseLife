...
from octoverse.api.app import create_app
from octoverse.constants import HOLDER, Constants
from octoverse.constants import registry as R
from octoverse.engine import pow as device
from octoverse.engine import world
from octoverse.models import Account, Base
...
async def _подготовить_мир() -> dict:
    ...
    async with async_sessionmaker(engine, expire_on_commit=False)() as db:
        ...
        vein = await world.create_vein(db, node, "Руда", richness=60, remaining=100_000)
...
def client(шахтёр, monkeypatch):
    ...
    from octoverse.db import base as db_base
