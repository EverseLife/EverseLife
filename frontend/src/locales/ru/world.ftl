...
ui-map-road-rule = Покрытие поднимается на ступень за полотно и время: бездорожье → тропинка → дорога → мощёный тракт. Тропинку протаптывают ноги, и без ходьбы она зарастает; без содержания зарастает и дорога. Ни по бездорожью, ни по тропинке обоз не идёт.
...
ui-ship-feed-hint = Порт без отметок ничего не берёт и никуда не льёт. Отметьте тару; порядок отметок — порядок, в каком порт берёт из неё или льёт в неё.
ui-ship-feed-none = Машин с линиями на борту нет: двигатель, система жизнеобеспечения, электролизёр, автоматический реактор и гидропонная установка появятся здесь, когда встанут в отсек.
ui-ship-feed-reset = снять линию
...
ui-ship-scheme-hint = Дорожки — отсеки в порядке закладки: слева машины, справа тара. Линию ведут от точки порта к таре — перетаскиванием или щелчком по порту, а затем по таре. Щелчок по линии открывает её порт, щелчок по таре без выбранного порта — её имя.
ui-ship-scheme-read-only = Линии проводит и тару называет владелец корабля у консоли; экипаж видит схему как есть.
ui-ship-scheme-none = На борту нет машин с портами: двигатель, система жизнеобеспечения, электролизёр, автоматический реактор и гидропонная установка появятся здесь, когда встанут в отсек.
ui-ship-scheme-way-in = вход
ui-ship-scheme-way-out = выход
ui-ship-scheme-way-vent = сток
...
ui-ship-scheme-unline = снять с линии
