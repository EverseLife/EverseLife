...
ui-farm-rule = Делянка живёт тремя шкалами — влага, здоровье, рост, — и числом видна только влага: она уходит долей от текущей, у реки вдвое медленнее. Полив до цели и подкормка в фазу — отдельные действия ногами; засуха и перелив губят, не то удобрение жжёт. Как ухаживать — текст в Библиотеке. Монокультура истощает землю, чередование и пар лечат — межа помнит, что на ней росло.
