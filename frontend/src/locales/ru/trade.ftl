...
ui-workshop-station-take = Снять
ui-workshop-station-take-hint = снять станцию — ляжет там же, где стояла; в руки — уже оттуда, сколько унесёте
ui-workshop-input = { $goods } · под рукой { $amount }
ui-workshop-most = Максимум
ui-workshop-most-hint = подставить в поле наибольшую партию, какую потянет всё под рукой и позволит станция
...
ui-workshop-repair-worn = на себе
ui-workshop-invent-title = Без рецепта
ui-workshop-invent-rule = Выложите состав на единицу изделия — до { $cap } видов того, что под рукой, — и сколько единиц делаете. Совпало с тем, что здесь делают, — рецепт ваш и партия пошла. Не совпало — сгорает случайная часть выложенного: цена попытки. Подсказок «теплее — холоднее» нет.
ui-workshop-invent-empty = Под рукой пусто: выкладывать нечего.
...
ui-inventory-gear = Снаряжение
ui-inventory-gear-rule = Надетое стоит здесь, а не в списке вещей: с ним нельзя ничего сделать по ошибке — ни выложить на прилавок, ни разобрать, ни отдать. Сначала снимите. Вес надетого ноша считает по-прежнему, поэтому он показан в строке. Чинят снаряжение не снимая — у того станка, на котором оно сделано.
ui-inventory-unequip = снять
# Снятие каркаса опускает предел носимого, и лишнее ложится под ноги (D-306).
ui-inventory-unequip-drops = снять каркас: всё, что не влезет в руки, ляжет под ноги
# Там, где нечем дышать, скафандр не снимают и не заменяют вещью, которая не скафандр (D-343).
ui-inventory-suit-stays-on = здесь нечем дышать: скафандр не снять и не заменить ничем, кроме другого скафандра, — переодеваются на борту или там, где есть воздух
...
ui-inventory-warm-hint = сломать грелку: в мерзлоте — часы теплозапаса сразу, сверх потолка не копятся
...
ui-inventory-draw = Нарисовать карту
ui-inventory-draw-hint = нарисовать на листе места из памяти: стоит выносливости, как копирование рецепта; карта держит их, пока цела
ui-inventory-install = Установить
ui-inventory-install-hint = поставить в здание: займёт место и станет рабочей; положенное на пол — просто груз
...
ui-bank-title = Банк
ui-bank-rule = Залога нет: лимит выдаёт труд — оборот и проценты, уплаченные по займам. Занимает вам ваш город со своей маржой, и пока его линия не исчерпана, ставка ниже: дальше деньги идут напрямую у столицы, с надбавкой за риск.
...
ui-mint-cost = Уйдёт { $metal } «{ $metalName }» (под рукой { $metalHave }) и { $iron } «{ $ironName }» (под рукой { $ironHave }). Лигатура — десятая часть железа: монета всегда 900-й пробы.
...
ui-printer-note = Личность цела: имя, знания, счёт и обязательства пережили тело. Из того, что тело несло, уцелевшее осталось лежать на месте гибели: под обвалом — всё целым, в остальных случаях — { $share }% в повреждённом виде.
...
ui-library-care-note = Агротехника восьми базовых культур — текст для всех: прочтите здесь и запомните, чтобы читать где угодно. Окно нормы не рисует — норма в тексте. Запомненное помечено ✓.
...
# Порог качества и шаг цены (D-239, D-241). Покупка берёт всё не хуже
# названного, продажа идёт лотом своей ступени — одна фраза на оба правила,
# потому что игрок принимает одно решение.
ui-market-floor = не хуже, качество
ui-market-floor-rule = Покупка возьмёт «{ $floor }» и всё, что лучше; продажа идёт лотом ступени «{ $tier }».
# Ступень своего buy-ордера с полом, названным рукой внутри ступени: без него
# покупатель не восстановит собственные условия (D-239, D-225).
ui-market-order-floor = { $tier } (не хуже { $floor })
ui-market-step = шаг цены
ui-market-step-auto = авто
ui-market-step-auto-title = шаг подбирает сервер: самый мелкий, при котором стакан помещается
