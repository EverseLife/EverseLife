...
ui-intro-go = Начать
ui-intro-again = Открыть снова — знак «?» в шапке.
...
ui-doors-not-required = не требуется
...
ui-doors-rules-note = Строки таблицы движок исполняет: обязательное гражданство наступает в момент печати и держит весь срок, налог удерживается с каждой продажи. У Принтера Предтеч условий нет — машина ничья.
...
ui-doors-back = ← назад
ui-doors-term-always = обязательно
ui-doors-term-hours = обязательно · { $hours } ч
ui-doors-term-days = обязательно · { $days } сут
...
ui-city-loan-rule = Казна занимает у ЦБ на общественные работы: по ключевой, без маржи и без надбавок, на общей кредитной линии города — той же, что несёт займы граждан.
...
## Гражданство: одно на человека, вход по уставу, выход со сроком (D-160, D-184)
...
ui-admin-citizenship-leaving = выходите: гражданство спадёт { $when }
ui-admin-citizenship-bound = обязательство кончится { $when }
...
ui-admin-leave-bound-title = срок обязательства вы приняли, выбрав дверь этого города
ui-admin-leave-title = заявление уходит по Сети
ui-admin-leave = Выйти из гражданства
ui-admin-leave-bound-note = Обязательство печати держит до своего срока.
ui-admin-leave-note = Выход не мгновенен: гражданство спадёт по сроку.
