...
ui-doors-back = ← назад
ui-doors-pick-on-globe = Выберите принтер — крупную точку на глобусе или имя выше: карточка выбранного появится здесь.

## Глобус у входа и на шаге принтера (D-319, D-013)
ui-entry-globe-label = глобус планеты
ui-entry-globe-hint = Мир, каким его знают все: города и дороги планеты. Поворачивается мышью или пальцем, колесо — ближе и дальше.
ui-entry-globe-doors-hint = Крупные точки — принтеры, у которых вас могут напечатать: щелчок открывает карточку рядом.
