...
ui-entry-globe-doors-hint = Крупные точки — принтеры, у которых вас могут напечатать: щелчок открывает карточку рядом. Глобус вращается перетаскиванием, колесо приближает.
