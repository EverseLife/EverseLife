...
ui-entry-globe-doors-hint = Крупные точки — принтеры, у которых вас могут напечатать: выберите точку, и откроется её карточка. Глобус поворачивается перетаскиванием.
