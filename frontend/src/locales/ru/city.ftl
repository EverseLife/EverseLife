...
ui-entry-globe-doors-hint = Точки — биопринтеры, на которых вас могут напечатать: чем больше точка, тем больше граждан в её городе. Выберите точку — откроется её карточка; глобус поворачивается перетаскиванием.
