...
# Тара со сбросным газом (D-340): опорожняют наружу, где нет воздуха, или в
# факельную установку узла.
ui-liquid-vent = { $way ->
        [flare] Сжечь в факеле
       *[void] Выпустить наружу
    }
ui-liquid-vent-hint = { $way ->
        [flare] сбросной газ сгорит в факельной установке узла
       *[void] снаружи нет воздуха: газ уйдёт наружу, и гореть ему не с чем
    }

## Выбор качества: что пустить в дело.

ui-tier-none = качество: под рукой нет
ui-tier-none-title = «{ $goods }» под рукой нет
ui-tier-any = качество: любое (худшее первым)
ui-tier-title = какое качество «{ $goods }» пустить в дело
# Строка одной ступени в списке: сколько её под рукой и в каком разбросе качества.
ui-tier-stock = { $tier } · { $amount } · кач. { $span }

## Досягаемость работы: откуда она берёт материалы (D-315).

ui-work-reach = Работа берёт материалы из рук, из своего обоза и — там, где место ваше — с пола, со двора и из поставленных здесь сундуков
