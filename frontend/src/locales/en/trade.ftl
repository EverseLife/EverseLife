...
ui-workshop-station-take = Take down
ui-workshop-station-take-hint = take the station down — it lies where it stood; into your hands from there, as much as you can carry
ui-workshop-input = { $goods } · at hand { $amount }
ui-workshop-most = Max
ui-workshop-most-hint = fill in the largest batch everything at hand can pay for, up to what one batch may hold
...
ui-workshop-repair-worn = on you
ui-workshop-invent-title = Without a recipe
ui-workshop-invent-rule = Lay out the composition of one unit — up to { $cap } kinds of what is at hand — and how many units you make. Match what is made here and the recipe is yours and the batch has started. Miss and a random part of what you laid out burns: the price of the attempt. There are no “warmer — colder” hints.
ui-workshop-invent-empty = Nothing at hand: there is nothing to lay out.
...
ui-inventory-gear = Gear
ui-inventory-gear-rule = What is worn stands here rather than in the list of things: nothing can be done to it by accident — not laid out on the counter, not taken apart, not handed over. Take it off first. Its weight still counts against the load, which is why the row shows it. Gear is repaired without being taken off, at the machine it was made at.
...
ui-inventory-warm-hint = break the warmer: in the frost, hours of warmth at once, nothing keeps past the ceiling
...
ui-inventory-draw = Draw a map
ui-inventory-draw-hint = draw the places you remember onto the sheet: costs stamina, like copying a recipe; the map keeps them for as long as it lasts
...
ui-mint-cost = { $metal } of “{ $metalName }” (at hand { $metalHave }) and { $iron } of “{ $ironName }” (at hand { $ironHave }) will be spent. The alloy is a tenth part iron: a coin is always of the 900 fineness.
...
ui-library-care-note = The agronomy of the eight basic crops is a text for everyone: read them here and remember them to read anywhere. The window draws no norm — the norm is in the text. What is remembered is marked ✓.
