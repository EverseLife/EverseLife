...
ui-place-plot-wild = Land outside a city is nobody's: the deed is issued by a city, and there is none here. Anyone may work and build here — what is put up belongs to whoever put it up.
...
ui-place-equipment-charge = charge { $charge } · charged in “estate”
...
ui-place-equipment-drop-station = drag a station here to put it up in the building
ui-place-equipment-drop-furniture = drag furniture here to furnish the building
ui-place-equipment-place = Put up:
ui-place-equipment-place-hint = put up in the building
...
ui-place-convoy-unharness-rule = The convoy stays here with its cargo; it goes over neither trackless ground nor a trail.
...
ui-holdings-no-way = There is no way there: the nodes share no edge.
...
ui-place-site-at-hand = at hand { $have }
ui-place-site-add = Bring
ui-place-site-add-hint = bring: as much as the bill still takes
