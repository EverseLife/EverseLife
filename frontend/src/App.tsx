  ...
  if (!look) {
    return (
      <main className="entry">
        ...
        <p className="note">
          Новый персонаж печатается у биопринтера с <b>нулём на счету</b>: мир
          денег не выдаёт. Подъёмные платит город, если его власть так решила, —
          это перевод из казны, а не эмиссия (D-153).
        </p>
        <p className="note">
          Опознание по имени — заглушка разработки. Настоящая аутентификация
          приезжает с подпиской (Э7, D-027).
        </p>
              ...
              <div className="panels">
                ...
                {пусто && (
                  <section>
                    ...
                    <p className="note">
                      Здесь ничего не стоит — только дороги. Транзитный узел
                      ценен положением, а не содержимым.
                    </p>
                  </section>
                )}
              </div>
