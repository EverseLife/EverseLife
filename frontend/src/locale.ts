...
const NAME_DOMAINS: Record<string, readonly (keyof Names)[]> = {
  ...
  CULTURE: ["plants"],
  //: The culture's written paragraph (D-311). Its own domain because it is
  //: keyed by the culture and is not a name: a missing paragraph must not
  //: read as a missing name.
  LORE: ["plant_care"],
