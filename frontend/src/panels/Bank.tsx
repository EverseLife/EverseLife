...
export function Bank({ session, busy, act }: Props) {
  ...
  return (
    <>
      ...
      <Rule>
        Залога нет: лимит выдаёт труд — оборот и уже погашенные кредиты.
        Занимает вам ваш город со своей маржой, и пока его линия не исчерпана,
        ставка ниже: дальше деньги идут напрямую у столицы, с надбавкой за риск.
      </Rule>
