  ...
  return (
    <div className="veil" role="dialog" aria-modal="true" aria-label="Что произошло">
      <section className="intro">
        ...
        <Rule>
          Сводка считается от того момента, когда вы её закрыли в прошлый раз.
          Всё, у чего есть срок, показано с остатком в настоящих часах: пропущенный
          срок в этом мире необратим, поэтому о нём говорят заранее, а не после.
        </Rule>
      </section>
    </div>
  );
